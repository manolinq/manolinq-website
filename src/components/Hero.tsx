    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {/* Mobile: constrain & scale; desktop: passthrough */}
            <div
              className="mx-auto lg:mx-0 overflow-hidden lg:overflow-visible"
              style={{ maxWidth: 'min(88vw, 100%)' }}
            >
              <div className="hero-mockup-inner relative">
                {/* Central glow orb */}
                <div
