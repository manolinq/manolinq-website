...
export default function LandingPagesPage() {
  useSeo({
    ...
    description:
      'Focused, high-converting landing pages built for one offer, campaign or service. Perfect for ads, promotions, launches and lead generation.',
  ...
  return (
    <ServiceDetail
      tag="Landing Pages"
      title={<>One page. <span className="electric-gradient-text">One offer.</span> More leads.</>}
      description="A focused, high-converting one-page website built around a single offer, campaign or service — designed to turn ad clicks and visitors into enquiries and bookings."
      path="/services/landing-pages"
      seoTitle=""
      seoDescription=""
      features={[
        ...
        {
          title: 'Fast-loading mobile layout',
